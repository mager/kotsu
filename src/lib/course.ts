...
export const radicalRecipes: RadicalRecipe[] = [
	...
	{ id: 'person-tree-rest', parts: ['人', '木'], result: '休', meaning: 'rest', pattern: 'person leaning against a tree' },
	{ id: 'two-fires-flame', parts: ['火', '火'], result: '炎', meaning: 'flame', pattern: 'fire stacked on fire' },
	{ id: 'mountain-stone-boulder', parts: ['山', '石'], result: '岩', meaning: 'boulder', pattern: 'stone at the foot of a mountain' },
	{ id: 'woman-child-good', parts: ['女', '子'], result: '好', meaning: 'good', pattern: 'woman and child together = good, beloved' },
	{ id: 'field-power-man', parts: ['田', '力'], result: '男', meaning: 'man', pattern: 'strength working the field' },
	{ id: 'gate-sun-interval', parts: ['門', '日'], result: '間', meaning: 'interval', pattern: 'light through the gap in a gate' },
	{ id: 'gate-ear-hear', parts: ['門', '耳'], result: '聞', meaning: 'hear', pattern: 'ear pressed to a gate' },
	{ id: 'roof-woman-peace', parts: ['宀', '女'], result: '安', meaning: 'peaceful', pattern: 'woman sheltered under a roof' },
	{ id: 'roof-child-character', parts: ['宀', '子'], result: '字', meaning: 'character', pattern: 'child learning under a roof' },
	{ id: 'grain-fire-autumn', parts: ['禾', '火'], result: '秋', meaning: 'autumn', pattern: 'grain dried by fire — harvest season' },
	{ id: 'mouth-ten-old', parts: ['十', '口'], result: '古', meaning: 'old', pattern: 'ten generations of mouths = ancient' },
	{ id: 'hand-eye-watch', parts: ['手', '目'], result: '看', meaning: 'watch over', pattern: 'hand shading the eye to look far' },
	{ id: 'brain-heart-think', parts: ['田', '心'], result: '思', meaning: 'think', pattern: 'heart below the old symbol for the brain (looks like 田)' },
	{ id: 'person-word-trust', parts: ['亻', '言'], result: '信', meaning: 'trust', pattern: 'a person\'s word is their bond' },
	{ id: 'tree-eye-mutual', parts: ['木', '目'], result: '相', meaning: 'mutual', pattern: 'eye looking into a tree — observing each other' },
	{ id: 'person-mountain-hermit', parts: ['亻', '山'], result: '仙', meaning: 'hermit', pattern: 'person who lives on a mountain' },
	{ id: 'woods-fire-burn', parts: ['林', '火'], result: '焚', meaning: 'burn', pattern: 'woods set on fire' },
	{ id: 'tree-sun-east', parts: ['木', '日'], result: '東', meaning: 'east', pattern: 'sun rising through a tree — the eastern sky' }
];
